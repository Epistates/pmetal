...
impl MistralAttention {
    ...
    pub fn forward_with_cache(
        ...
        // Apply RoPE. Explicit positions win over the cache offset: a packed
        // batch has no cache, and a cached decode has no explicit positions.
...
impl AttentionModule for MistralAttention {
    fn forward_with_cache(
        ...
        MistralAttention::forward_with_cache(self, x, mask, cache, positions)
    }
}
...
impl DecoderLayer for MistralDecoderLayer {
    fn forward_with_cache(
        ...
        MistralDecoderLayer::forward_with_cache(self, x, mask, cache, positions)
    }
}
...
impl MistralForCausalLM {
    ...
    /// [`MistralModel::forward_with_positions`].
    pub fn forward_with_positions(
        &mut self,
        input_ids: &Array,
        mask: Option<&Array>,
