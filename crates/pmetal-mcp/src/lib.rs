...
impl PmetalMcpServer {
    ...
    async fn train(
        ...
        #[description("Train DoRA (Weight-Decomposed LoRA) adapters instead of plain LoRA")]
        dora: Option<bool>,
        #[description("Use rank-stabilized LoRA scaling (alpha/sqrt(r))")] rslora: Option<bool>,
        #[description("Dropout on the LoRA branch (default: 0.0)")] lora_dropout: Option<f64>,
        ...
        let mut spec = TrainSpec {
            ...
            dora: dora.unwrap_or(false),
            rslora: rslora.unwrap_or(false),
            lora_dropout: lora_dropout.unwrap_or(0.0) as f32,
